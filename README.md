...
<h1 align="center">
  Airflow Redmine Provider
</h1>
  <h3 align="center">
  Guidelines on building, deploying, and maintaining provider packages that will help Airflow users interface with external systems.
</h3>
...
def get_provider_info():
    return {
        ...
        "description": "A redmine template for Apache Airflow providers.",  # Required
        "connection-types": [
            {"connection-type": "redmine", "hook-class-name": "redmine_provider.hooks.redmine.RedmineHook"}
        ],
